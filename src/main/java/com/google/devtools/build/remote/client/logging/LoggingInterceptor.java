...
package com.google.devtools.build.remote.client.logging;
...
public class LoggingInterceptor implements ClientInterceptor {
  ...
  private class LoggingForwardingCall<ReqT, RespT>
    ...
    public void start(Listener<RespT> responseListener, Metadata headers) {
      entryBuilder.setStartTime(Utils.getCurrentTimestamp(clock));
      ...
      super.start(
          new ForwardingClientCallListener.SimpleForwardingClientCallListener<RespT>(
            ...
            public void onClose(Status status, Metadata trailers) {
              entryBuilder.setEndTime(Utils.getCurrentTimestamp(clock));
