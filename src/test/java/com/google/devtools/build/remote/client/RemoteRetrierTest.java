...
import com.google.devtools.build.remote.client.RemoteRetrier.ExponentialBackoff;
import com.google.devtools.build.remote.client.Retrier.Backoff;
import com.google.devtools.build.remote.client.Retrier.Sleeper;
...
public class RemoteRetrierTest {
  ...
  public void testNoRetries() throws Exception {
    RemoteRetrier retrier =
        Mockito.spy(new RemoteRetrier(false, (e) -> true, retryService, Retrier.ALLOW_ALL_CALLS));
    when(fooMock.foo())
        .thenReturn("bla")
  ...
  public void testInterruptedExceptionIsPassedThrough() throws Exception {
    ...
    RemoteRetrier retrier =
        new RemoteRetrier(false, (e) -> true, retryService, Retrier.ALLOW_ALL_CALLS);
    try {
      retrier.execute(() -> {
        throw thrown;
      });
